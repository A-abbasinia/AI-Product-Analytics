...
class AnalyticsEngine:
    """
    Core analytics computations over registry tables.
    """
    ...
    def total_revenue(
        ...
        has_user_filter = (
            filters and any(f.column == "user_id" for f in filters)
        )
        ...
        if has_user_filter:
            ...
            merged = AnalyticsEngine._apply_filters(
                merged,
                filters
            )
        ...
        transactions = AnalyticsEngine._apply_filters(
            transactions,
            filters
        )
    ...
    def total_orders(
        ...
        orders = AnalyticsEngine._apply_filters(
            orders,
            filters
        )
